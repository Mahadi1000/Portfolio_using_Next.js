...
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.</p>
          ...
          <div className='col-span-3 order-1 md:order-none h-max relative rounded-2xl flex justify-center items-center border-2 z-0 border-solid dark:border-light border-dark bg-light p-8'>
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  I learned MERN Stack Web Development from Programming Hero. It was 6 months of course. And now I am a Junior Web Developer  
                  </div>
                  {/* Education DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2023 - 2024{" "}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* Education TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                  B.Sc - Honours in Botany at Govt.Titumir College, Dhaka University
