...
const Footer = () => {
  return (
    <footer className='w-full dark:text-light border-t-2 border-solid border-dark font-medium text-[14px] md:text-lg'>
        <Layout className='md:py-8 flex items-center justify-between flex-col lg:flex-row py-5 gap-2'>
